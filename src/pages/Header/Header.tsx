  ...
  return (
    <header className={style.header}>
      <Link to="/" className={style.logo}>
        ...
        <p className={style.header__logo}>NFT Marketplace</p>
      </Link>
      <nav>
        <Link to="/marketplace" className={style.header__nav}>
          Marketplace
        </Link>
        <Link to="/ranking" className={style.header__nav}>
          Ranking
        </Link>
        <Link to="/connetc" className={style.header__nav}>
          Connect to wallet
        </Link>
        <Link to="/Singup">
